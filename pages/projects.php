...
<body class="store-page">
    ...
    <div class="container my-5 text-center">
      <h1 class="text-dark text-center m-4 fw-bold mt-5" style="font-family: 'Roboto'">Research Unit of Robotics Projects</h1>
      <p class="text-secondary" style="font-family: 'Roboto';">The following projects were conceptualized and developed by the talented RUR personnel </p>
      <hr>
    </div>
